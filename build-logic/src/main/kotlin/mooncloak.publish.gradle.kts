...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("mooncloak-website")
        description.set("The mooncloak website UI.")
        url.set("https://github.com/mooncloak/mooncloak-website")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/mooncloak-website/issues")
        ...
        developers {
            ...
            developer {
                ...
                roles.set(setOf("Primary mooncloak-website developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/mooncloak-website.git")
            developerConnection.set("https://github.com/mooncloak/mooncloak-website.git")
            url.set("https://github.com/mooncloak/mooncloak-website")
        }
    }
}
